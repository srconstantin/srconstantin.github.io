...
Short selling does not increase immediately before news about a stock is published, but does increase after,_ _suggesting that short sellers are making their decisions on the basis of public news rather than anticipating that news.  Moreover, the returns on short sales are more than twice as high on days when there is news about a stock, which also suggests that short sellers are making better use of public information than other investors.[5]
